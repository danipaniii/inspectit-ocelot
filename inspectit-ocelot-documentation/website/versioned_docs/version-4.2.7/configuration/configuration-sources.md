---
id: version-4.2.7-configuration-sources
...
```bash
$ java -javaagent:/path/to/inspectit-ocelot-agent-4.2.7.jar="{ \"inspectit\": { \"service-name\": \"My Custom Service\" }}" -jar my-java-program.jar
```
...
```bash
$ java -Dinspectit.service-name="My Custom Service" -javaagent:/path/to/inspectit-ocelot-agent-4.2.7.jar -jar my-java-program.jar
```
...
```bash
$ INSPECTIT_SERVICE_NAME="My Custom Service" java -javaagent:/path/to/inspectit-ocelot-agent-4.2.7.jar -jar my-java-program.jar
```
