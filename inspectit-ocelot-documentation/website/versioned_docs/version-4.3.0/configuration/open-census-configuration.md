---
id: version-4.3.0-open-census-configuration
...
1. Make sure you are using the same version of OpenCensus as inspectIT Ocelot.
   ...
   The inspectIT Ocelot agent in version 4.3.0 internally uses OpenCensus in version 0.31.1. Please adapt any OpenCensus dependency in your application to this version to avoid run-time conflicts.
   ```XML
   <dependency>
